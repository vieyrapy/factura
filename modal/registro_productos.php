		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax_productos"></div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="precio" name="precio" placeholder="Precio de venta del producto" required pattern="^[0-9]{1,15}?$" title="Ingresa sólo números con 0 ó 2 decimales" maxlength="16">
				</div>
			  </div>
