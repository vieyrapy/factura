<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE clientes SET nombre_cliente='".$nombre."', ruc_cliente='".$ruc."', telefono_cliente='".$telefono."', email_cliente='".$email."', direccion_cliente='".$direccion."', status_cliente='".$estado."' WHERE id_cliente='".$id_cliente."'";
