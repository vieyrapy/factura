        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    &copy; <?php echo "Studio Digital Sánchez "; echo  $anio=date('Y'); ?>
                </td>
            </tr>
        </table>
    </page_footer>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
       ...
       <br>
		...
		<tr>
		  ...
		  <td style="width:25%;"><?php echo date("d/m/Y H:i:s", strtotime($fecha_factura));?></td>
		   <td style="width:40%;" >
				<?php 
...
while ($row=mysqli_fetch_array($sql))
	...
	$total_iva=($subtotal * $impuesto )/110;
